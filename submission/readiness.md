...
| Public open-source repository | [GitHub repository](https://github.com/skaiea13-ai/recalllease-cockroach-aws), MIT license, complete source, and pinned Pages workflow | Public; privacy-safe history rewrite pending explicit push approval |
...
The public repository and Pages site exist. The currently published Git history
still contains entrant identity metadata; the local rewrite removes it but has
not been pushed. No cloud execution proof, Devpost project, or public video has
